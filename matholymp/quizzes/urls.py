...
urlpatterns = [
    ...
    path('evaluacion/<int:pk>/resultados/enviar-retroalimentacion/', views.enviar_retroalimentacion, name='enviar_retroalimentacion'),
    path('evaluacion/<int:pk>/resultados/descargar-retroalimentacion-pdf/', views.descargar_retroalimentacion_pdf, name='descargar_retroalimentacion_pdf'),
